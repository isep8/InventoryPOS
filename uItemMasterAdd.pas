...
type
  TfrmItemMasterAdd = class(TForm)
    ...
    procedure edtWholesalePriceExit(Sender: TObject);
  private
...
begin
    ...
    begin
        ...
        begin
            ...
            begin
                ...
                begin
                    ...
                    tblMastStockBalance.Value:= StrToFloat(FormatFloat('#########.00',( strtoFloat(edtStockBalance.Text))));
        ...
        //add to unit of measure
        with qry2Chk do
        begin
            Close;
            SQL.clear;
            SQL.Add('Select * From UnitOfMeasure');
            SQL.Add('Where UMCode=:asUMCode');
            ParamByName('asUMCode').Value:= Trim(cboUM.Text);
            Open;
        end;
        ...
        begin
            ...
            begin
                Close;
                SQL.clear;
                SQL.Add('Insert into UnitOfMeasure(UMCode)');
                SQL.Add('Values(:asUMCode)');
                ParamByName('asUMCode').Value:= Trim(cboUM.Text);
                ExecSql;
                Close;
            end;
...
procedure TfrmItemMasterAdd.edtWholesalePriceExit(Sender: TObject);
begin
    //edtWholesalePrice.Text:= FormatFloat('#########.00', StrToFloat(edtWholesalePrice.text));
