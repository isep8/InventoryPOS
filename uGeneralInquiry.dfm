object frmGeneralInquiry: TfrmGeneralInquiry
    ...
    object TabSheet7: TTabSheet
      ...
      object lstReport: TListBox
        ...
        Items.Strings = (
          ...
          'SOLD ITEMS BY DATE'
          'SOLD ITEMS PER CUSTOMER NAME'
          'SOLD ITEMS PER CUSTOMER PER PAGE'
          ''
          'GROSS SALES REPORT'
          'GROSS SOLD ITEMS'
          ''
  ...
  object rvByCustomer: TRvDataSetConnection
    RuntimeVisibility = rtDeveloper
    DataSet = qry2ByCustomer
    Left = 861
    Top = 287
  end
  object qry2ByCustomer: TffQuery
    DatabaseName = 'AndroidPOS'
    SessionName = 'Sess1'
    SQL.Strings = (
      
        'SELECT distinct a.refno, a.soldto, a.soldtoaddress1, a.soldtoadd' +
        'ress2, a.totalItems, a.totalOrigPrice, '
      
        'a.TotalAmount, b.NetAmount, b.ItemCode, b.barcode, b.Description' +
        ', b.Location, b.discountamt, '
      
        'b.EnteredDate, b.UnitOfMeasure, b.Qty FROM SalesHeader202105 a i' +
        'nner join SalesDetail202105 b'
      'on a.RefNo = b.RefNo')
    Left = 853
    Top = 339
    object qry2ByCustomerrefno: TStringField
      FieldName = 'refno'
      Size = 15
    end
    object qry2ByCustomersoldto: TStringField
      FieldName = 'soldto'
      Size = 15
    end
    object qry2ByCustomersoldtoaddress1: TStringField
      FieldName = 'soldtoaddress1'
      Size = 30
    end
    object qry2ByCustomersoldtoaddress2: TStringField
      FieldName = 'soldtoaddress2'
      Size = 30
    end
    object qry2ByCustomertotalItems: TIntegerField
      FieldName = 'totalItems'
    end
    object qry2ByCustomertotalOrigPrice: TFloatField
      FieldName = 'totalOrigPrice'
    end
    object qry2ByCustomerTotalAmount: TFloatField
      FieldName = 'TotalAmount'
    end
    object qry2ByCustomerNetAmount: TFloatField
      FieldName = 'NetAmount'
    end
    object qry2ByCustomerItemCode: TStringField
      FieldName = 'ItemCode'
    end
    object qry2ByCustomerbarcode: TStringField
      FieldName = 'barcode'
      Size = 30
    end
    object qry2ByCustomerDescription: TStringField
      FieldName = 'Description'
      Size = 40
    end
    object qry2ByCustomerLocation: TStringField
      FieldName = 'Location'
    end
    object qry2ByCustomerdiscountamt: TFloatField
      FieldName = 'discountamt'
    end
    object qry2ByCustomerEnteredDate: TDateField
      FieldName = 'EnteredDate'
    end
    object qry2ByCustomerUnitOfMeasure: TStringField
      FieldName = 'UnitOfMeasure'
      Size = 3
    end
    object qry2ByCustomerQty: TFloatField
      FieldName = 'Qty'
    end
  end
  object dsByCustomer: TDataSource
    DataSet = qry2ByCustomer
    Left = 850
    Top = 386
  end
