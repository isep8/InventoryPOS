...
try
    ...
    begin
        ...
        frmPOS.edtRefNo.Text:= FormatDateTime('yy', now)+ Format('%.*d',[6, tblRefLastInvoiceNo.Value]) ; //tblRefLastRefYY.AsString +  Format('%.*d',[2,  tblRefLastRefMM.Value]) + '-' + Format('%.*d',[5, tblRefLastReferenceNo.Value]);
        tblRef.Close;
    end;
    ...
    begin
        ...
        tblHdrSoldTo.Value:= UpperCase(frmPOS.edtCustomerType.Text);
