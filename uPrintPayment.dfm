object frmPrintPayment: TfrmPrintPayment
  Left = 326
  Top = 150
  Width = 706
  Height = 431
  BorderIcons = [biSystemMenu]
  Caption = 'View Payment and Adjustment Transaction(s)'
  Color = 13164732
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object lblTransAmount: TLabel
    Left = 16
    Top = 368
    Width = 144
    Height = 13
    Caption = 'Total transaction amount: 0.00'
  end
  ...
  object Label1: TLabel
    ...
    Width = 229
    Height = 13
    Caption = '(Input reference no to print payment transaction.)'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
  ...
  object edtRefNo: TNxNumberEdit
    ...
    TabOrder = 0
    Text = '0'
    OnChange = edtRefNoChange
    OnKeyDown = edtRefNoKeyDown
  ...
  object rdoRefNo: TRadioButton
    ...
    TabOrder = 5
    TabStop = True
    OnClick = rdoRefNoClick
  end
  object rdoInvoice: TRadioButton
    Left = 10
    Top = 33
    Width = 87
    Height = 17
  ...
  object rvPrintPayment: TRvDataSetConnection
